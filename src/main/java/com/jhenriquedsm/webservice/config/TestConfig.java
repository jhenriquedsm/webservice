...
import com.jhenriquedsm.webservice.entities.*;
import com.jhenriquedsm.webservice.entities.enums.OrderStatus;
import com.jhenriquedsm.webservice.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, Instant.parse("2025-01-01T21:00:07Z"), o1);
        o1.setPayment(pay1);
